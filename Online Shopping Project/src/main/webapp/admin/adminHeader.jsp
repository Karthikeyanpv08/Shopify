...
<body>
    ...
    <div class="topnav sticky">
      <%String email=session.getAttribute("email").toString(); %>
            ...
            <center><h2>Shopify</h2></center>
            <a href="addNewProduct.jsp">Add New Product <i class='fas fa-plus-square'></i></a>
            <a href="allProductEditProduct.jsp">All Products <i class='fab fa-elementor'></i></a>
            <a href="Coupon.jsp">Add New Coupon <i class='fas fa-plus-square'></i></a>
